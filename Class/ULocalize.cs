...
namespace Sunny.UI
{
    public static class UILocalize
    {
        ...
        /// 提示
        /// </summary>
        public static string InfoTitle = "InfoTitle";

        /// <summary>
        /// 正确
        /// </summary>
        public static string SuccessTitle = "SuccessTitle";
        ...
        /// 提示
        /// </summary>
        public static string AskTitle = "AskTitle";

        /// <summary>
        /// 输入
        /// </summary>
        public static string InputTitle = "InputTitle";
        ...
        /// [ 无数据 ]
        /// </summary>
        public static string GridNoData = "[ GridNoData ]";

        /// <summary>
        /// 数据加载中，请稍候...
        /// </summary>
        public static string GridDataLoading = "Data loading, please wait...";
        ...
        public static string SelectPageLeft = "Page";
        public static string SelectPageRight = "Page";
